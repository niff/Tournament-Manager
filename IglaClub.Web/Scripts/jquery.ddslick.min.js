(function (a) {
    ...
    var b = {},
        ...
        d = '<div class="dd-select"><input name="temp_name" class="dd-selected-value" type="hidden" /><a class="dd-selected"></a><span class="dd-pointer dd-pointer-down"></span></div>',
        e = '<ul class="dd-options"></ul>',
        f = '<style id="css-ddslick" type="text/css">' +
            ".dd-select{ border-radius:3px;   height: 25px;border:solid 1px #ccc; position:relative; cursor:pointer;}" +
    ...
    b.init = function (b) {
        ...
        return this.each(function () {
            ...
            if (!f) {
                ...
                c.replaceWith(l);
                c = l;
                var withName = d.replace("temp_name", $(c[0]).attr("id"));
                c.addClass("dd-container").append(withName).append(e);
