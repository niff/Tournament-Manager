(function (a) {
    ...
    var b = {},
        ...
        d = '<div class="dd-select"><input name="dd-selected-value" class="dd-selected-value" type="hidden" /><a class="dd-selected"></a><span class="dd-pointer dd-pointer-down"></span></div>',
        e = '<ul class="dd-options"></ul>',
        f = '<style id="css-ddslick" type="text/css">' +
            ".dd-select{ border-radius:3px;margin-top: -9px; border:solid 1px #ccc; position:relative; cursor:pointer;}" +
